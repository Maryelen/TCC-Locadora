                ...
                <form role="form" id="formAtual" name="formAtual">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>Email</label>
                                <input class="form-control" placeholder="Informe o email" type="text" id="txtEmail" name="txtEmail" value="${usuario.email}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>Tipo</label>
                                <input class="form-control" placeholder="Informe o Tipo" type="text" id="txtTipo" name="txtTipo" value="${usuario.tipo}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
