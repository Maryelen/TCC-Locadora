                        ...
                        <tbody>
                            <c:forEach var="locadora" items="${locadoras}">
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>${locadora.site}</td>
                                    <td>
                                        <a href="#" class="btn-circle" id="${locadora.id}">
                                            <i class="fa fa-youtube-play fa-fw"></i>Reservar
                                        </a>
                                        &nbsp;
                                        <a href="#" class="btn-info" id="${locadora.id}">
                                            <i class="fa fa-edit fa-fw"></i>Detalhar
                                        </a>                        
                                    </td>
                                </tr>
                            </c:forEach>
